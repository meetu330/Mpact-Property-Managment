...
class Duplicate_data_housefile extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      user: [],
  ...
  async componentDidMount() {
    ...
    if (answer_array[2] == "localhost:3000") {
      var url =
        "http://localhost/react_app/backend/api/duplicate_data_listing_housefile";
    } else {
      var url =
        "https://mpact.justcodenow.com/react_app/api/duplicate_data_listing_housefile";
    }
...
export default Duplicate_data_housefile;
