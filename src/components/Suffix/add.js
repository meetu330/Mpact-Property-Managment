...
const Suffixadd = () => {
  ...
  function suffixadd() {
    if (Suffix) {
      ...
      setSuffixError("Please Enter Suffix Name");
    }
    ...
    if (Suffix) {
      ...
      fd.append("vName", Suffix);
      const dataa = axios
        .post(url, fd)
        .then((res) => {
          if (res.data.Status == "0") {
            swal("Suffix Data", res.data.message, "success");
            setTimeout(function () {
              history.push("/suffix/add");
  ...
  const answer_array = answer.split("/");
  if (answer_array[2] == "localhost:3000") {
    var urls = `http://localhost/react_app/backend/api/get_all_suffix`;
  } else {
    var urls = `https://mpact.justcodenow.com/react_app/api/get_all_suffix`;
  }
                  ...
                  <div className="card-body">
                    <div className="row">
                      <div className="col-lg-4">
                        <div className="form-group">
                          ...
                          />
                          <span className="red">{SuffixError}</span>
                        </div>
                      </div>
                    ...
                    <div className="row">
                      ...
                      <div className="col-lg-4">
                        <div className="form-group">
                          <label className="form-control-label" for="vTitle">
                            Suffix or Abbreviation (ALLEE,ALLEY,ALLY)
                          </label>
                          <input
                            type="text"
                            id="vTitle"
