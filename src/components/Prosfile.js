...
import csv from "../../src/image/csv.png";
import Leftside from "./Leftside";
import $ from "jquery";

export default class Prosfile extends React.Component {
  state = {
    selectFile: null,
    selecttype: null,
    selectname: null,
            ...
            <div id="layoutSidenav_content">
              <main>
                <div className="container-fluid px-4">
                  <h1 className="mt-4 mb-3 txt">Prospecting File</h1>
